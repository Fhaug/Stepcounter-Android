...
public class DBAdapter {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_STEPS};
    ...
    // DataBase info:
    public static final String DATABASE_NAME = "Steps";
    public static final String DATABASE_TABLE = "DailySteps";
