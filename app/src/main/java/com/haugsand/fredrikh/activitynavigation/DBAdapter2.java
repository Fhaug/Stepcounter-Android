...
public class DBAdapter2 {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_STEPS, KEY_DATE};
    ...
    // DataBase info:
    public static final String DATABASE_NAME = "DAILY_HISTORY";
    public static final String DATABASE_TABLE = "STEPS";
    ...
    public boolean updateRow(long rowId, String steps, String date) {
        String where = KEY_ROWID + "=" + rowId;
